(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[67],{BHWx:function(e,i,t){"use strict"
t.r(i)
var a=t("ODXe")
var l=t("mNVu")
var _=t("Cf7h")
const n=ENV.FILES_CONTEXTS||[]
const o={contexts:n,contextsDictionary:n.reduce((e,i)=>{const t=Array.from(Object(_["a"])(i.asset_string)),l=Object(a["a"])(t,2),n=l[0],o=l[1]
i.contextType=n
i.contextId=o
e[[n,o].join("_")]=i
...
t("YGE8")
v.openRestrictedDialog=function(){var e=d()("<div>").dialog({title:b.t("Editing permissions for: %{name}",{name:this.props.model.displayName()}),width:800,minHeight:300,close:function(){r.a.unmountComponentAtNode(this)
d()(this).remove()}})
t.e(115).then(t.bind(null,"Vm4Q")).then(i=>{let t=i.default
...
t.d(i,"a",function(){return o})
var a=t("btHx")
var l=t("GLiE")
var _=t.n(l)
var n=t("jFQ7")
class o extends a["a"]{initialize(){this.on("change:sort change:order",this.setQueryStringParams)
...
this.url=i.toString()
return this.reset()}}o.optionProperty("parentFolder")
o.prototype.model=n["a"]},dfg0:function(e,i,t){"use strict"
var a=t("FIFq")
var l=t.n(a)
var _=t("GLiE")
var n=t.n(_)
...
a.add(e,{merge:true})
return a}
return i}(l.a.Model)},"gSD+":function(e,i,t){"use strict"
var a=t("rePB")
var l=t("1OyB")
var _=t("vuIU")
var n=t("md7G")
...
var m=t("n12J")
var p=t("J2CL")
function k(e,i,t){if("input"===e.as){if("children"===i&&e.children||void 0==e.value)return new Error("Prop `value` and not `children` must be supplied if `".concat(t,' as="input"`'))}else{if("value"===i&&void 0!=e.value)return new Error("Prop `children` and not `value` must be supplied unless `".concat(t,' as="input"`'))
if(!e.children)return new Error("Prop `children` should be supplied unless `".concat(t,' as="input"`.'))}return}var h=t("KgFQ")
var v=t("jtGx")
var g=t("oXx0")
function y(e){var i=e.borders,t=e.colors,a=e.spacing,l=e.typography
return{fontFamily:l.fontFamily,fontWeight:l.fontWeightNormal,lineHeight:l.lineHeightFit,h1FontSize:l.fontSizeXXLarge,h1FontWeight:l.fontWeightLight,h2FontSize:l.fontSizeXLarge,h2FontWeight:l.fontWeightNormal,h3FontSize:l.fontSizeLarge,h3FontWeight:l.fontWeightBold,h4FontSize:l.fontSizeMedium,h4FontWeight:l.fontWeightBold,h5FontSize:l.fontSizeSmall,h5FontWeight:l.fontWeightNormal,primaryInverseColor:t.textLightest,primaryColor:t.textDarkest,secondaryColor:t.textDark,secondaryInverseColor:t.textLight,brandColor:t.textBrand,warningColor:t.textWarning,errorColor:t.textDanger,successColor:t.textSuccess,borderPadding:a.xxxSmall,borderColor:t.borderMedium,borderWidth:i.widthSmall,borderStyle:i.style}}y.canvas=function(e){return{primaryColor:e["ic-brand-font-color-dark"],brandColor:e["ic-brand-primary"]}}
...
var z=(N=Object(g["a"])(),x=Object(p["i"])(y,F),N(C=x(C=(w=j=function(e){Object(s["a"])(i,e)
function i(){Object(l["a"])(this,i)
return Object(n["a"])(this,Object(o["a"])(i).apply(this,arguments))}Object(_["a"])(i,[{key:"render",value:function(){var e
var t=this.props,l=t.border,_=t.children,n=t.color,o=t.level,s=t.ellipsis,r=t.margin,d=t.elementRef
var f=Object(h["a"])(i,this.props,function(){return"reset"===o?"span":o})
var u=m["a"].omitViewProps(Object(v["a"])(this.props,i.propTypes),i)
return c.a.createElement(m["a"],Object.assign({},u,{className:b()((e={},Object(a["a"])(e,F.root,true),Object(a["a"])(e,F[o],true),Object(a["a"])(e,F["color-".concat(n)],n),Object(a["a"])(e,F["border-".concat(l)],"none"!==l),Object(a["a"])(e,F.ellipsis,s),e)),as:f,margin:r,elementRef:d,__dangerouslyIgnoreExperimentalWarnings:true}),_)}}])
i.displayName="Heading"
return i}(r["Component"]),j.propTypes={border:f.a.oneOf(["none","top","bottom"]),children:k,color:f.a.oneOf(["primary","secondary","primary-inverse","secondary-inverse","inherit"]),level:f.a.oneOf(["h1","h2","h3","h4","h5","reset"]),as:f.a.elementType,ellipsis:f.a.bool,margin:p["c"].spacing,elementRef:f.a.func},j.defaultProps={children:null,margin:void 0,elementRef:void 0,border:"none",color:"inherit",level:"h2",ellipsis:false},w))||C)||C)},jFQ7:function(e,i,t){"use strict"
var a=t("ouhR")
var l=t.n(a)
var _=t("GLiE")
var n=t.n(_)
...
//# sourceMappingURL=67-c-78c45722cf.js.map