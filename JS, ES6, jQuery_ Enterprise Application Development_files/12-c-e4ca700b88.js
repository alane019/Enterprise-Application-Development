(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[12],{"4Pkj":function(e,r,t){"use strict"
...
var u=t("jtGx")
var p=t("KgFQ")
var y=function(e){Object(s["a"])(r,e)
function r(){Object(a["a"])(this,r)
return Object(i["a"])(this,Object(c["a"])(r).apply(this,arguments))}Object(o["a"])(r,[{key:"render",value:function(){var e=Object(n["a"])({},Object(u["a"])(this.props,r.propTypes),{"aria-hidden":"true"})
var t=Object(p["a"])(r,this.props)
return l.a.createElement(t,e,this.props.children)}}])
r.displayName="PresentationContent"
return r}(d["Component"])
y.propTypes={children:_.a.node,as:_.a.elementType}
y.defaultProps={as:"span",children:null}},"5JRF":function(e,r,t){"use strict"
var n=t("rePB")
var a=t("1OyB")
var o=t("vuIU")
var i=t("md7G")
...
var B=(k=Object(y["i"])(h,w),k(g=(U=v=function(e){Object(s["a"])(r,e)
function r(){Object(a["a"])(this,r)
return Object(i["a"])(this,Object(c["a"])(r).apply(this,arguments))}Object(o["a"])(r,[{key:"render",value:function(){var e
var t=this.props,a=t.wrap,o=t.weight,i=t.fontStyle,c=t.size,s=t.lineHeight,d=t.letterSpacing,b=t.transform,_=t.color,u=t.children
var y=Object(j["a"])(r,this.props)
return l.a.createElement(y,Object.assign({},Object(m["a"])(this.props,r.propTypes),{className:p()((e={},Object(n["a"])(e,w.root,true),Object(n["a"])(e,w[c],c),Object(n["a"])(e,w["wrap-".concat(a)],a),Object(n["a"])(e,w["weight-".concat(o)],o),Object(n["a"])(e,w["style-".concat(i)],i),Object(n["a"])(e,w["transform-".concat(b)],b),Object(n["a"])(e,w["lineHeight-".concat(s)],s),Object(n["a"])(e,w["letterSpacing-".concat(d)],d),Object(n["a"])(e,w["color-".concat(_)],_),e)),ref:this.props.elementRef}),u)}}])
r.displayName="Text"
return r}(d["Component"]),v.propTypes={as:_.a.elementType,wrap:_.a.oneOf(["normal","break-word"]),weight:_.a.oneOf(["normal","light","bold"]),fontStyle:_.a.oneOf(["italic","normal"]),size:_.a.oneOf(["x-small","small","medium","large","x-large","xx-large"]),lineHeight:_.a.oneOf(["default","fit","condensed","double"]),letterSpacing:_.a.oneOf(["normal","condensed","expanded"]),transform:_.a.oneOf(["none","capitalize","uppercase","lowercase"]),color:_.a.oneOf(["primary","secondary","primary-inverse","secondary-inverse","success","error","alert","warning","brand"]),children:_.a.node,elementRef:_.a.func},v.defaultProps={as:"span",wrap:"normal",size:"medium",letterSpacing:"normal",children:null,elementRef:void 0,color:void 0,transform:void 0,lineHeight:void 0,fontStyle:void 0,weight:void 0},U))||g)},IRk9:function(e,r,t){"use strict"
...
var l=t.n(d)
var b=t("hPGw")
var _=l.a.createElement("path",{d:"M771.548 960.11L319 1412.658l188.562 188.562 452.548-452.548 452.548 452.548 188.562-188.562-452.548-452.548 452.548-452.548L1412.658 319 960.11 771.548 507.562 319 319 507.562z",fillRule:"nonzero",stroke:"none",strokeWidth:"1"})
var u=function(e){Object(s["a"])(r,e)
function r(){Object(a["a"])(this,r)
return Object(i["a"])(this,Object(c["a"])(r).apply(this,arguments))}Object(o["a"])(r,[{key:"render",value:function(){return l.a.createElement(b["a"],Object.assign({},this.props,{name:"IconX",viewBox:"0 0 1920 1920"}),_)}}])
r.displayName="IconXSolid"
return r}(d["Component"])
u.glyphName="x"
u.variant="Solid"
u.propTypes=Object(n["a"])({},b["a"].propTypes)},WfMV:function(e,r,t){"use strict"
t.d(r,"a",function(){return g})
var n=t("VTBJ")
var a=t("1OyB")
var o=t("vuIU")
var i=t("md7G")
...
var g=(j=Object(u["i"])(null,k),j(m=(h=f=function(e){Object(s["a"])(r,e)
function r(){Object(a["a"])(this,r)
return Object(i["a"])(this,Object(c["a"])(r).apply(this,arguments))}Object(o["a"])(r,[{key:"render",value:function(){var e=Object(n["a"])({},Object(p["a"])(this.props,r.propTypes),{className:k.root})
var t=Object(y["a"])(r,this.props)
return l.a.createElement(t,e,this.props.children)}}])
r.displayName="ScreenReaderContent"
return r}(d["Component"]),f.propTypes={as:_.a.elementType,children:_.a.node},f.defaultProps={as:"span",children:null},h))||m)},dqQ7:function(e,r,t){"use strict"
var n=t("An8g")
var a=t("q1tI")
var o=t.n(a)
t("17x9")
...
var y=t("WfMV")
var j=t("XQb/")
t.d(r,"a",function(){return v})
t.d(r,"b",function(){return U})
t.d(r,"c",function(){return w})
...
return Object(n["a"])(u["a"],{as:"p",fontStyle:"italic"},void 0,Object(n["a"])(u["a"],{},void 0,r),t?k:null,t?Object(n["a"])(u["a"],{},void 0,t):null)}render(){let e=null
this.props.error&&(e=this.state.showDetails?this.renderDetailMessage():Object(n["a"])("span",{},void 0,Object(n["a"])(p["a"],{},void 0,Object(n["a"])(_["a"],{variant:"link",onClick:this.showDetails},void 0,l.t("Details"))),Object(n["a"])(y["a"],{},void 0,this.renderDetailMessage())))
return Object(n["a"])(j["a"],{transitionOnMount:true,in:this.state.isOpen,type:"fade"},void 0,Object(n["a"])(b["a"],{variant:this.props.variant,renderCloseButtonLabel:l.t("Close"),onDismiss:this.closeAlert,margin:"small auto",timeout:this.props.timeout,liveRegion:this.getLiveRegion,transition:"fade",screenReaderOnly:this.props.screenReaderOnly},void 0,Object(n["a"])("div",{},void 0,Object(n["a"])("p",{style:{margin:"0 -5px"}},void 0,this.props.message),e)))}}g.defaultProps={error:null,variant:"info",timeout:h,screenReaderOnly:false}
function v(e){let r=e.message,t=e.err,a=e.type,o=void 0===a?t?"error":"info":a,i=e.srOnly,s=void 0!==i&&i
...
document.body.appendChild(e)}return e}function b(e){c.a.render(Object(n["a"])(g,{message:r,timeout:isNaN(ENV.flashAlertTimeout)?h:ENV.flashAlertTimeout,error:t,variant:o,onClose:d.bind(null,e),screenReaderOnly:s}),e)}const _=document.createElement("div")
_.setAttribute("style","max-width:50em;margin:1rem auto;")
_.setAttribute("class","flashalert-message")
l().appendChild(_)
b(_)}function U(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:l.t("An error occurred making a network request")
return r=>v({message:e,err:r,type:"error"})}function w(e){return()=>v({message:e,type:"success"})}},nAyT:function(e,r,t){"use strict"
...
t("DEX3")
var c=t("jcII")
var s=Object(c["a"])(function(e,r,t,c){var s=function(e){Object(i["a"])(r,e)
function r(){Object(n["a"])(this,r)
return Object(a["a"])(this,Object(o["a"])(r).apply(this,arguments))}return r}(e)
false
return s})
s.deprecatePropValues=function(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[]
var t=arguments.length>2?arguments[2]:void 0
return function(n,a,o){var i=r.includes(n[a])
"[".concat(o,"] The '").concat(n[a],"' value for the `").concat(a,"` prop is deprecated. ").concat(t||"")
for(var c=arguments.length,s=new Array(c>3?c-3:0),d=3;d<c;d++)s[d-3]=arguments[d]
return i?null:e.apply(void 0,[n,a,o].concat(s))}}
function d(e,r,t,n){var a=arguments.length>4&&void 0!==arguments[4]?arguments[4]:""
Object.keys(n).forEach(function(o){if("undefined"!==typeof t[o]){var i="string"===typeof n[o]?n[o]:null
var c=i?". Use `".concat(i,"` instead"):""
"[".concat(e,"] `").concat(o,"` is deprecated and will be removed in version ").concat(r).concat(c,". ").concat(a)}})}s.warnDeprecatedProps=d
function l(e,r,t){"[".concat(r,"] is deprecated and will be removed in version ").concat(e,". ").concat(t||"")}s.warnDeprecatedComponent=l
s.changedPackageWarning=function(e,r){return"It has been moved from @instructure/".concat(e," to @instructure/").concat(r,".")}}}])

//# sourceMappingURL=12-c-e4ca700b88.js.map